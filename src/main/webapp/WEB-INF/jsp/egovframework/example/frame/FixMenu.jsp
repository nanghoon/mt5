...
<div class="header bg-none">
	 <div class="header-top bg-none">
	 	<div class="header-frame">
            <div class="h-right">
              ...
              <select onchange="changeLang(this)" class="select-field bg-none w-select">
	...
	<div class="header-main">
		...
		<div class="menu">
			...
			<div class="drop-menu">
				<a href="/company" class="menu_btn bg-none w-button"><spring:message code="menu.company"/></a> 
			</div>
			<div class="drop-menu">
				<a href="#" class="menu_btn bg-none w-button"><spring:message code="menu.trading"/></a>
				<div class="drop-list">
					<div>Trading</div>
			...
			<div class="drop-menu">
				<a href="/socialTrading" class="menu_btn bg-none w-button"><spring:message code="menu.socialTrading"/></a> 
			</div>
			<div class="drop-menu">
				<a href="#" class="menu_btn bg-none w-button"><spring:message code="menu.troyTool"/></a>
				<div class="drop-list">
					<div>Troy-Tool</div>
			...
			<div class="drop-menu">
				<a href="/metaTrader5" class="menu_btn bg-none w-button"><spring:message code="menu.metaTrader"/></a> 
			</div>
			<div class="drop-menu">
				<a href="#" class="menu_btn bg-none w-button"><spring:message code="menu.csCenter"/></a>
				<div class="drop-list">
					<div>CS Center</div>
			...
			<div class="connected-btn-box">
				<a href="#" class="connected-btn bg-none w-button"><spring:message code="menu.connected"/></a>
				<a href="#" class="connected-btn bg-none on w-button"><spring:message code="menu.connectedWallet"/></a>
			</div>
		</div>
		<a href="#" class="mobile-menu w-button"></a>
	</div>	
</div>
